...
class Vwlistgroupsaccess extends Model {
    protected $DBGroup = 'default';
    protected $table      = 'administration.vw_list_access_groups'; // OJO  usamos la misma vista pero el controller es diferente porque tiene que sacar de otro campo
