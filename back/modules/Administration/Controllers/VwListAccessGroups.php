...
use \Modules\Administration\Models\VwListAccessGroups as VwListAccessGroupsModel;

class VwListAccessGroups extends ResourceController{
    ...
    public function show($id=null){
        ...
        $sqlTotal = "SELECT count(*) as total FROM administration.sp_getaccessxgroups({$id}) WHERE {$where_['keyword']}";
        $sql = "SELECT *,({$sqlTotal}) from administration.sp_getaccessxgroups({$id}) $where";
